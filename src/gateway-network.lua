...
Handlers.add('info', Handlers.utils.hasMatchingTag('Action', 'Info'), function(msg)
    ao.send(
        { Target = msg.From, Tags = { Name = Name, Ticker = Ticker, Logo = Logo, ProcessOwner = Owner, Denomination = tostring(Denomination), LastGARSyncTimestamp = tostring(LastGARSyncTimestamp), GatewaysRegistered = tostring(tableCount(Gateways)) } })
end)
